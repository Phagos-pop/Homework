...
namespace HW_06_task1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Поле и метод доступны из любого места текущего проекта. Здесь доступны
            ...
            //Это поле мы можем изменять и выводить, так как она обладает модификатором public. Этот модификатор дает доступ к полю и функции
            // Метод тоже нам доступен.

            sportBike.CheckFuelPrivate();
            sportBike.vinNumberPrivat = "q3211314";

            //Явно указаный модификатор доступа private. Поле и функция не доступны
